    ...
    function getTasks($st)
    {
        ...
        while($row = $result->fetch_assoc()){
            ...
            if($status == 'to do' && $st == 1 || $status == 'in progress' && $st == 2 || $status == 'done' && $st == 3){
                ...
                if($status == 'to do') echo('<script>document.getElementById("to-do-tasks-count").innerHTML++</script>');
                else if($status == 'in progress') echo('<script>document.getElementById("in-progress-tasks-count").innerHTML++</script>');
                else if($status == 'done') echo('<script>document.getElementById("done-tasks-count").innerHTML++</script>');   
            }
